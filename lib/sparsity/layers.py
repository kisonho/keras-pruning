...
class PrunedLayer(layers.Layer):
    ...
    @classmethod
    def from_config(cls: Type[PrunedLayer], cfg: dict[str, Any], layers_module: Any = layers) -> PrunedLayer:
        # build target
        target_cfg = cfg["target"]
        target_type: Type[layers.Layer] = getattr(layers_module, cfg["type"])
